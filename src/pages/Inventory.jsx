                ...
                {filteredFG.map(p => {
                  ...
                  return (
                    <div key={p.code} className={'stock-item ' + cls}
                      ...
                      {TRAY_SIZE[p.code] ? (
                        <span>
                          <div className="si-units">{(p.units / TRAY_SIZE[p.code]).toFixed(2)}</div>
                          <div className="si-packs">{p.units} units &middot; {TRAY_SIZE[p.code]}/tray</div>
                        </span>
                      ) : (
                        <span>
                          <div className="si-units">{p.units}</div>
                          <div className="si-packs">{Math.floor(p.units/ps)}pk &middot; {ps}/pk</div>
                        </span>
                      )}
